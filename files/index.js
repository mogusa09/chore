...
const UUID = process.env.UUID || 'fd80f56e-93f3-4c85-b2a8-c77216c509a7'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'n';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '5d80';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.sameen.nom.za';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNzJiYmZiNWMyY2JhNGM2ZDJmNzdhZGZjYjNhZDc0MDUiLCJ0IjoiMWFiOGRkMDAtMGJiZC00NTJkLWJiZWItMjU4ZTI5OWI4ZWMwIiwicyI6Ik5EYzNaR0ptWkRNdFlXRm1ZUzAwT0dFeUxUaGxNalF0WkRKaE1UYzRPV001WW1ReiJ9';
const CFIP = process.env.CFIP || 'www.who.int';
